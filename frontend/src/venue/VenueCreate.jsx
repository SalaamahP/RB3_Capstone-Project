...
export default function VenueCreate() {
  ...
  const handleSubmit = React.useCallback(async () => {
    try{
      await createVenue(formState.values);
      notifications.show(`Venue added successfully`,{
        severity: 'success',
      ...
      notifications.show(
        `Failed to add venue. Reason: ${error.message}`,
  ...
  return (
    <PageContainer
    title= "New Venue"
    breadcrumbs={[{title: `Venues`, path: `/venue`}, {title: `New`}]}
    >
