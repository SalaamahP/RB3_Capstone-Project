      ...
      <FormGroup>
        <Grid container spacing={2} sx={{ mb: 2, width: '100%' }}>
            ...
            <TextField
              ...
              helperText={formErrors.venueName ?? ' '}
              fullWidth
            />
          </Grid>
          <Grid size={{ xs: 12, sm: 6 }} sx={{ display: 'flex' }}>
            <TextField
              ...
              error={!!formErrors.venueLocation}
              helperText={formErrors.venueLocation ?? ' '}
              fullWidth
            />
          </Grid>
              <Grid size={{ xs: 12, sm: 6 }} sx={{ display: 'flex' }}>
...
VenueForm.propTypes = {
  ...
  formState: PropTypes.shape({
    ...
    venueName: PropTypes.string,
      venueLocation: PropTypes.string,
